...
import type {
  BasicForeignBridge,
  BasicForeignBridgeInterface,
} from "../../../contracts/upgradeable_contracts/BasicForeignBridge";
...
export class BasicForeignBridge__factory {
  static readonly abi = _abi;
  static createInterface(): BasicForeignBridgeInterface {
    return new Interface(_abi) as BasicForeignBridgeInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): BasicForeignBridge {
    return new Contract(address, _abi, runner) as unknown as BasicForeignBridge;
  }
}
