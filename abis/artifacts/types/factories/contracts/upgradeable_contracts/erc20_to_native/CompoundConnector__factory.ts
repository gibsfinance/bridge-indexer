...
import type {
  CompoundConnector,
  CompoundConnectorInterface,
} from "../../../../contracts/upgradeable_contracts/erc20_to_native/CompoundConnector";
...
export class CompoundConnector__factory {
  static readonly abi = _abi;
  static createInterface(): CompoundConnectorInterface {
    return new Interface(_abi) as CompoundConnectorInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): CompoundConnector {
    return new Contract(address, _abi, runner) as unknown as CompoundConnector;
  }
}
