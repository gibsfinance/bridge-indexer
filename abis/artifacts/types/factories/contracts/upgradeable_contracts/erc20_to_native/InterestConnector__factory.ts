...
import type {
  InterestConnector,
  InterestConnectorInterface,
} from "../../../../contracts/upgradeable_contracts/erc20_to_native/InterestConnector";
...
export class InterestConnector__factory {
  static readonly abi = _abi;
  static createInterface(): InterestConnectorInterface {
    return new Interface(_abi) as InterestConnectorInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): InterestConnector {
    return new Contract(address, _abi, runner) as unknown as InterestConnector;
  }
}
