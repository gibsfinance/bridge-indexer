...
import type {
  TokenBridgeMediator,
  TokenBridgeMediatorInterface,
} from "../../../contracts/upgradeable_contracts/TokenBridgeMediator";
...
export class TokenBridgeMediator__factory {
  static readonly abi = _abi;
  static createInterface(): TokenBridgeMediatorInterface {
    return new Interface(_abi) as TokenBridgeMediatorInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as TokenBridgeMediator;
  }
}
