...
import type {
  ...
  AsyncInformationProcessorInterface,
} from "../../../../contracts/upgradeable_contracts/arbitrary_message/AsyncInformationProcessor";
...
export class AsyncInformationProcessor__factory {
  static readonly abi = _abi;
  static createInterface(): AsyncInformationProcessorInterface {
    return new Interface(_abi) as AsyncInformationProcessorInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as AsyncInformationProcessor;
  }
}
