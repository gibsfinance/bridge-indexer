...
import type {
  BasicForeignAMB,
  BasicForeignAMBInterface,
} from "../../../../contracts/upgradeable_contracts/arbitrary_message/BasicForeignAMB";
...
export class BasicForeignAMB__factory {
  static readonly abi = _abi;
  static createInterface(): BasicForeignAMBInterface {
    return new Interface(_abi) as BasicForeignAMBInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): BasicForeignAMB {
    return new Contract(address, _abi, runner) as unknown as BasicForeignAMB;
  }
}
