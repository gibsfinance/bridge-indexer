...
import type {
  BasicHomeAMB,
  BasicHomeAMBInterface,
} from "../../../../contracts/upgradeable_contracts/arbitrary_message/BasicHomeAMB";
...
export class BasicHomeAMB__factory {
  static readonly abi = _abi;
  static createInterface(): BasicHomeAMBInterface {
    return new Interface(_abi) as BasicHomeAMBInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): BasicHomeAMB {
    return new Contract(address, _abi, runner) as unknown as BasicHomeAMB;
  }
}
