...
} from "../../../../contracts/upgradeable_contracts/arbitrary_message/MessageDelivery";
...
export class MessageDelivery__factory {
  static readonly abi = _abi;
  static createInterface(): MessageDeliveryInterface {
    return new Interface(_abi) as MessageDeliveryInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): MessageDelivery {
    return new Contract(address, _abi, runner) as unknown as MessageDelivery;
  }
}
