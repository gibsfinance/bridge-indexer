...
export interface IUniswapRouterV2Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IUniswapRouterV2 extends BaseContract {
  connect(runner?: ContractRunner | null): IUniswapRouterV2;
