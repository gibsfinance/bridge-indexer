...
export interface ERC677BridgeTokenRewardableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "removeBridge"
      | "mintingFinished"
...
export interface ERC677BridgeTokenRewardable extends BaseContract {
  connect(runner?: ContractRunner | null): ERC677BridgeTokenRewardable;
  waitForDeployment(): Promise<this>;

  interface: ERC677BridgeTokenRewardableInterface;
