...
export interface PermittableTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "mintingFinished"
      | "name"
...
export interface PermittableToken extends BaseContract {
  connect(runner?: ContractRunner | null): PermittableToken;
