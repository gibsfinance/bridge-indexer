...
export interface FeeManagerMockInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface FeeManagerMock extends BaseContract {
  connect(runner?: ContractRunner | null): FeeManagerMock;
  ...
  randomTest: TypedContractMethod<[_count: BigNumberish], [bigint], "view">;
