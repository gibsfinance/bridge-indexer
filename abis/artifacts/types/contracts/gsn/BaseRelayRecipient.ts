...
export interface BaseRelayRecipientInterface extends Interface {
  getFunction(
    nameOrSignature: "versionRecipient" | "isTrustedForwarder"
  ): FunctionFragment;
...
export interface BaseRelayRecipient extends BaseContract {
  connect(runner?: ContractRunner | null): BaseRelayRecipient;
