...
export interface ForeignAMBWithGasTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "transactionHash"
      | "sourceChainId"
...
export interface ForeignAMBWithGasToken extends BaseContract {
  connect(runner?: ContractRunner | null): ForeignAMBWithGasToken;
  waitForDeployment(): Promise<this>;

  interface: ForeignAMBWithGasTokenInterface;
