...
export interface BasicHomeAMBInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "transactionHash"
      | "numMessagesSigned"
...
export interface BasicHomeAMB extends BaseContract {
  connect(runner?: ContractRunner | null): BasicHomeAMB;
  waitForDeployment(): Promise<this>;

  interface: BasicHomeAMBInterface;
