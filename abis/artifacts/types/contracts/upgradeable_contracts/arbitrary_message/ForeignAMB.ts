...
export interface ForeignAMBInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "transactionHash"
      | "sourceChainId"
...
export interface ForeignAMB extends BaseContract {
  connect(runner?: ContractRunner | null): ForeignAMB;
  waitForDeployment(): Promise<this>;

  interface: ForeignAMBInterface;
