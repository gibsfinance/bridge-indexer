...
export interface BasicForeignAMBInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "transactionHash"
      | "sourceChainId"
...
export interface BasicForeignAMB extends BaseContract {
  connect(runner?: ContractRunner | null): BasicForeignAMB;
  waitForDeployment(): Promise<this>;

  interface: BasicForeignAMBInterface;
