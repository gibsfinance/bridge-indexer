...
export interface MessageDeliveryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "transactionHash"
      | "sourceChainId"
...
export interface MessageDelivery extends BaseContract {
  connect(runner?: ContractRunner | null): MessageDelivery;
