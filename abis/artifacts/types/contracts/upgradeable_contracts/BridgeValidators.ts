...
export interface BridgeValidatorsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "validatorCount"
...
export interface BridgeValidators extends BaseContract {
  connect(runner?: ContractRunner | null): BridgeValidators;
  waitForDeployment(): Promise<this>;

  interface: BridgeValidatorsInterface;
