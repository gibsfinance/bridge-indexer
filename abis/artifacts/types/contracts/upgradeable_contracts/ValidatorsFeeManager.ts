...
export interface ValidatorsFeeManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ValidatorsFeeManager extends BaseContract {
  connect(runner?: ContractRunner | null): ValidatorsFeeManager;
  waitForDeployment(): Promise<this>;

  interface: ValidatorsFeeManagerInterface;
