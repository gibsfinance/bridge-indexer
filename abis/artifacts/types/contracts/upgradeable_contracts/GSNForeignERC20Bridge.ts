...
export interface GSNForeignERC20BridgeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "relayTokens"
      | "erc20token"
...
export interface GSNForeignERC20Bridge extends BaseContract {
  connect(runner?: ContractRunner | null): GSNForeignERC20Bridge;
  waitForDeployment(): Promise<this>;

  interface: GSNForeignERC20BridgeInterface;
