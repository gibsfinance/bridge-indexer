...
export interface InterestReceiverStakeBuybackInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "wethToken"
      | "stakeToken"
...
export interface InterestReceiverStakeBuyback extends BaseContract {
  connect(runner?: ContractRunner | null): InterestReceiverStakeBuyback;
  waitForDeployment(): Promise<this>;

  interface: InterestReceiverStakeBuybackInterface;
