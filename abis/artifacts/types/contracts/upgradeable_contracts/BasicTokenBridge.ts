...
export interface BasicTokenBridgeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "totalSpentPerDay"
...
export interface BasicTokenBridge extends BaseContract {
  connect(runner?: ContractRunner | null): BasicTokenBridge;
  waitForDeployment(): Promise<this>;

  interface: BasicTokenBridgeInterface;
