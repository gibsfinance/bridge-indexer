...
export interface InterestReceiverBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "wethToken"
      | "uniswapRouterV2"
...
export interface InterestReceiverBase extends BaseContract {
  connect(runner?: ContractRunner | null): InterestReceiverBase;
  waitForDeployment(): Promise<this>;

  interface: InterestReceiverBaseInterface;
