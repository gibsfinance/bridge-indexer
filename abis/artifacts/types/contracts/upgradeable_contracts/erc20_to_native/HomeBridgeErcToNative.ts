...
export interface HomeBridgeErcToNativeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "numMessagesSigned"
      | "totalBurntCoins"
...
export interface HomeBridgeErcToNative extends BaseContract {
  connect(runner?: ContractRunner | null): HomeBridgeErcToNative;
  ...
  totalBurntCoins: TypedContractMethod<[], [bigint], "view">;
  ...
  relayTokens: TypedContractMethod<[_receiver: AddressLike], [void], "payable">;
  ...
  initialize: TypedContractMethod<
    [
      ...
      _homeGasPrice: BigNumberish,
      _requiredBlockConfirmations: BigNumberish,
      _blockReward: AddressLike,
      _foreignDailyLimitForeignMaxPerTxArray: [BigNumberish, BigNumberish],
      _owner: AddressLike,
  ...
  rewardableInitialize: TypedContractMethod<
    [
      _validatorContract: AddressLike,
      _dailyLimitMaxPerTxMinPerTxArray: [
        BigNumberish,
      ...
      _owner: AddressLike,
      _feeManager: AddressLike,
      _homeFeeForeignFeeArray: [BigNumberish, BigNumberish],
      _decimalShift: BigNumberish
    ],
    [boolean],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "totalBurntCoins"
  ...
  ): TypedContractMethod<[_blockReward: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "rewardableInitialize"
  ): TypedContractMethod<
    [
      _validatorContract: AddressLike,
      _dailyLimitMaxPerTxMinPerTxArray: [
