...
export interface CompoundConnectorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "relayTokens"
      | "invest"
...
export interface CompoundConnector extends BaseContract {
  connect(runner?: ContractRunner | null): CompoundConnector;
  waitForDeployment(): Promise<this>;

  interface: CompoundConnectorInterface;
