...
export interface FeeManagerErcToNativeInterface extends Interface {
  getFunction(
    nameOrSignature:
      ...
      | "REWARD_FOR_TRANSFERRING_FROM_FOREIGN"
      | "REWARD_FOR_TRANSFERRING_FROM_HOME"
      | "getAmountToBurn"
      | "getHomeFee"
      | "calculateFee"
      | "getFeeManagerMode"
  ...
  encodeFunctionData(
    functionFragment: "REWARD_FOR_TRANSFERRING_FROM_FOREIGN",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "REWARD_FOR_TRANSFERRING_FROM_HOME",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface FeeManagerErcToNative extends BaseContract {
  connect(runner?: ContractRunner | null): FeeManagerErcToNative;
  waitForDeployment(): Promise<this>;

  interface: FeeManagerErcToNativeInterface;
  ...
  REWARD_FOR_TRANSFERRING_FROM_FOREIGN: TypedContractMethod<
    [],
    [string],
    "view"
  >;

  REWARD_FOR_TRANSFERRING_FROM_HOME: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "REWARD_FOR_TRANSFERRING_FROM_FOREIGN"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "REWARD_FOR_TRANSFERRING_FROM_HOME"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
