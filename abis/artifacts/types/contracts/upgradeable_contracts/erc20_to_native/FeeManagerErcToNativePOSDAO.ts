...
export interface FeeManagerErcToNativePOSDAOInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface FeeManagerErcToNativePOSDAO extends BaseContract {
  connect(runner?: ContractRunner | null): FeeManagerErcToNativePOSDAO;
  waitForDeployment(): Promise<this>;

  interface: FeeManagerErcToNativePOSDAOInterface;
