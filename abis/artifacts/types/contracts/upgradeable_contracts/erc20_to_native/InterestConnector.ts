...
export interface InterestConnectorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "relayTokens"
      | "invest"
...
export interface InterestConnector extends BaseContract {
  connect(runner?: ContractRunner | null): InterestConnector;
  waitForDeployment(): Promise<this>;

  interface: InterestConnectorInterface;
