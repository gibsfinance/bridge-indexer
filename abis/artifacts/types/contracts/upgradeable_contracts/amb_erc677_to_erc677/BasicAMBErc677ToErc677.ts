...
export interface BasicAMBErc677ToErc677Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "relayTokens"
      | "fixFailedMessage"
...
export interface BasicAMBErc677ToErc677 extends BaseContract {
  connect(runner?: ContractRunner | null): BasicAMBErc677ToErc677;
  waitForDeployment(): Promise<this>;

  interface: BasicAMBErc677ToErc677Interface;
