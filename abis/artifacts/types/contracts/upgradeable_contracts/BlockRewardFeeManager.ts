...
export interface BlockRewardFeeManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface BlockRewardFeeManager extends BaseContract {
  connect(runner?: ContractRunner | null): BlockRewardFeeManager;
  waitForDeployment(): Promise<this>;

  interface: BlockRewardFeeManagerInterface;
