...
export interface RewardableValidatorsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "validatorCount"
  ...
  encodeFunctionData(
    functionFragment: "addRewardableValidator",
...
export interface RewardableValidators extends BaseContract {
  connect(runner?: ContractRunner | null): RewardableValidators;
  waitForDeployment(): Promise<this>;

  interface: RewardableValidatorsInterface;
  ...
  addRewardableValidator: TypedContractMethod<
    [_validator: AddressLike, _reward: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "addRewardableValidator"
  ): TypedContractMethod<
    [_validator: AddressLike, _reward: AddressLike],
    [void],
    "nonpayable"
