...
export interface BaseBridgeValidatorsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "validatorCount"
...
export interface BaseBridgeValidators extends BaseContract {
  connect(runner?: ContractRunner | null): BaseBridgeValidators;
  waitForDeployment(): Promise<this>;

  interface: BaseBridgeValidatorsInterface;
