...
export interface RewardableBridgeInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface RewardableBridge extends BaseContract {
  connect(runner?: ContractRunner | null): RewardableBridge;
  waitForDeployment(): Promise<this>;

  interface: RewardableBridgeInterface;
